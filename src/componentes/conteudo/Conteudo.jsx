...
function Conteudo() {
    ...
    return (
        <div>
            <div id='servico' className='bg-yellow-500 h-full'>
            ...
            <div id='sobre' className='bg-black flex justify-center pt-20 pb-20'>
                <div className=''>
                ...
                <div className=''>
                    <img src={sobreimg} alt='imagem referente ao sobre' className='w-100 h-100'/>
                </div>
            </div>
